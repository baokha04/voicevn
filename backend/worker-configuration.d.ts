/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ea1cc4db39165912c195aff4c15f65b)
// Runtime types generated with workerd@1.20260426.1 2025-01-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VoiceVnAgent";
	}
	interface Env {
		AI: Ai;
		TTS_PROVIDER: "mock";
		TTS_API_URL: "https://api.external-tts-provider.com/v1/synthesize";
		VoiceVnAgent: DurableObjectNamespace<import("./src/index").VoiceVnAgent>;
	}
}
